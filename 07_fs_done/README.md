...
***Ответ:***<br>
Узнал. Для торрента хороший выбор.

2. Могут ли файлы, являющиеся жесткой ссылкой на один объект, иметь разные права доступа и владельца? Почему?

***Ответ:***<br>
hardlink это ссылка на тот же самый файл и имеет тот же inode, поэтому права будут одни и теже<br>
Пример:
```
# touch main.py
# ln main.py main.c
# ls -ilh
total 16K
5242887 -rw-r--r-- 2 root   root       0 Sep 13 05:22 main.c
5242887 -rw-r--r-- 2 root   root       0 Sep 13 05:22 main.py
```
...
--2021-09-13 08:20:09--  https://mirror.yandex.ru/ubuntu/ls-lR.gz
...
2021-09-13 08:20:12 (6.65 MB/s) - ‘/tmp/new/test.gz’ saved [20488555/20488555]
...
***Ответ:***<br>
```
22:12:43 vlad@upc(0):~/vagrant$ vagrant destroy
